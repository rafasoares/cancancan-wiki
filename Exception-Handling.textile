The @CanCan::AccessDenied@ exception is raised when calling @authorize!@ in the controller and the user is not authorized to perform the given action. A message can optional be provided.
