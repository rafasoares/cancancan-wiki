...
It is impossible to answer this `can?` question fully because not enough details are given. The class does not have a @priority@ attribute to check on.
